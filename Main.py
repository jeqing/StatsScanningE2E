...
if __name__ == "__main__":
    ...
    CheckSalesForce.checkDataInSalesForce('sunjeet81@gmail.com', 'yorks64&*', 'iKR2pcS09UvwRxMgaPcDjEi8', "SELECT Mark_In__c FROM Response__c WHERE Access_Code__c like ", docIdGuidList, errorLogLocation1, ["DocID", "Guid", "MarkIn_Status"])
